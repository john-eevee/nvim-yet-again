...
return {
  ...
  -- rust-tools for enhanced Rust support
  {
    ...
    config = function()
      ...
      map("n", "<leader>Rh", rt.hover_actions.hover_actions, vim.tbl_extend("force", opts, { desc = "Rust: Hover actions" }))
      map("n", "<leader>Ra", rt.code_action_group.code_action_group, vim.tbl_extend("force", opts, { desc = "Rust: Code actions" }))
      ...
      map("n", "<leader>Rp", rt.parent_module.parent_module, vim.tbl_extend("force", opts, { desc = "Rust: Parent module" }))
      map("n", "<leader>Rj", function()
        rt.join_lines.join_lines()
      end, vim.tbl_extend("force", opts, { desc = "Rust: Join lines" }))
      map("n", "<leader>Re", rt.expand_macro.expand_macro, vim.tbl_extend("force", opts, { desc = "Rust: Expand macro" }))
